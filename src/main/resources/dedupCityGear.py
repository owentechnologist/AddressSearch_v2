...
#  XADD X:GBG:CITY{groupA} * spellCheckMe sgcSomeCity6478 requestID 1
...
def dedupAndAssign(starttime,s1):
  ...
  execute('XADD', 'X:GEAR_DEDUPER_LOG{groupA}', '*','RECEIVED--> '+s1+' cityName: '+cityName+' requestID: '+requestID)
